...
<body style="  background:fixed url(./image/bg2.JPG);background-size: 100%;">
<div class="body1">
    <div class="container">
        <div class="content">
          <div class="left-side">
            <div class="address details">
              ...
              <br>
              <div class="text-one">Bright minds Academy</div>
              <div class="text-two">Rajam city,Vizianagaram District,Andhra Pradesh</div>
            </div>
            <div class="phone details">
              <i class="fas fa-phone-alt"></i>
              <div class="topic">Phone</div>
              <br>
              <div class="text-one">9398960873</div>
              <div class="text-two">9392483630</div>
            </div>
            <div class="email details">
              <i class="fas fa-envelope"></i>
              <div class="topic">Email</div>
              <br>
              <div class="text-one">batch 9</div>
              <div class="text-two">batch9@gmail.com</div>
              <br>
              <div class="text-one">Manisha</div>
              <div class="text-two">manisha@gmail.com</div>
            </div>
          </div>
          ...
          <form action="mailto:batch9@gmail.com,manisha@gmail.com" enctype="text/plain" method="post">
            <div class="input-box">
