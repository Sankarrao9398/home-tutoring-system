				...
				?>
			  	...
			  	<div class="itemrow">
			  			...
			  			<div style="width: 80%; float: left;">
			  				<div class="divp35"><input <?php $sub1=strstr($sub, "Telugu"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Telugu"><span>Telugu</span></div>
							...
							<div class="divp35"><input <?php $sub1=strstr($sub, "Mathematics"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Mathematics"><span>Mathematics</span></div>
							...
							<div class="divp35"><input <?php $sub1=strstr($sub, "Environmental studies"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Religion"><span>Environmental studies</span></div>
							...
							<div class="divp35"><input <?php $sub1=strstr($sub, "Higher Mathematics"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Higher Mathematics"><span>Higher Mathematics</span></div>
							...
							<div class="divp35"><input <?php $sub1=strstr($sub, "Geography"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Geography"><span>Geography</span></div>
							<div class="divp35"><input <?php $sub1=strstr($sub, "Hindi"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="Hindi"><span>Hindi</span></div>
			  			</div>
			  		</div>
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
								<div class="divp35"><input <?php $medium1=strstr($medium, "Telugu"); if($medium1 != '') echo 'checked'; ?> type="checkbox" name="medium_list[]" value="Telugu"><span>Telugu</span></div>
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$location.'" placeholder="e.g:Batch 9">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
							...
							<div style="width: 80%; float: left;">
							  ...
							  <option value="Bright Minds Academy">Bright Minds Academy</option>
							</select>
							</div>
						</div>
					<div class="itemrow">
